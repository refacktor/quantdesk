...
<body class="t4">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fquantdesk%2Fsource%2Fbrowse%2FQuantDesk_YahooData%2Fjava%2Fcom%2Fwinance%2Foptimizer%2Fsymbols%2FSymbol.java%3Fspec%3Dsvn22%26r%3D22" 
...
<div id="nav_and_rev" class="heading">
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/?r=22">QuantDesk_YahooData</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/?r=22">java</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/com/?r=22">com</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/com/winance/?r=22">winance</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/com/winance/optimizer/?r=22">optimizer</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/com/winance/optimizer/symbols/?r=22">symbols</a><span class="sp">/&nbsp;</span>Symbol.java</span>
...
><td class="source">public class Symbol<br></td></tr
><tr
id=sl_svn22_28
...
><td class="source">    public Symbol(String name)<br></td></tr
><tr
id=sl_svn22_31
...
><td class="source">        data = new SymbolDataCollection();<br></td></tr
><tr
id=sl_svn22_33
...
><td class="source">        data.addDataItem(date, open, high, low, close, volume);<br></td></tr
><tr
id=sl_svn22_39
...
><td class="source">    public ArrayList&lt;Double&gt; getRawValues(Calendar startDate, Calendar endDate)<br></td></tr
><tr
id=sl_svn22_42
...
><td class="source">        ArrayList&lt;Double&gt; ret = new ArrayList&lt;Double&gt;();<br></td></tr
><tr
id=sl_svn22_44

><td class="source">        ArrayList&lt;SymbolDataCollection.SymbolDataItem&gt; items = data.getFromInterval(startDate, endDate);<br></td></tr
><tr
id=sl_svn22_45
...
><td class="source">        for(int i=0;i&lt;items.size();i++)<br></td></tr
><tr
id=sl_svn22_47
...
><td class="source">            ret.add(items.get(i).open);<br></td></tr
><tr
id=sl_svn22_49
...
><td class="source">    public ArrayList&lt;SymbolRatioItem&gt; getReturnRatios(int year)<br></td></tr
><tr
id=sl_svn22_55
...
><td class="source">        return data.getAdjustedRatiosForYear(year);<br></td></tr
><tr
id=sl_svn22_57
...
><td class="source">     * @return the name<br></td></tr
><tr
id=sl_svn22_61
...
><td class="source">    public int getDataItemsCount()<br></td></tr
><tr
id=sl_svn22_68
...
><td class="source">    private String name;<br></td></tr
><tr
id=sl_svn22_73

><td class="source">    private SymbolDataCollection data;<br></td></tr
><tr
id=sl_svn22_74
...
<script type="text/javascript">
 ...
 by atramos
 on May 23, 2010
 &nbsp; <a href="/p/quantdesk/source/diff?spec=svn22&r=22&amp;format=side&amp;path=/QuantDesk_YahooData/java/com/winance/optimizer/symbols/Symbol.java&amp;old_path=/QuantDesk_YahooData/java/com/winance/optimizer/symbols/Symbol.java&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/QuantDesk_YahooData/java/com/winance/optimizer/symbols/Symbol.java';
 ...
 <a href="/p/quantdesk/source/list?path=/QuantDesk_YahooData/java/com/winance/optimizer/symbols/Symbol.java&start=22">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="http://quantdesk.googlecode.com/svn-history/r22/QuantDesk_YahooData/java/com/winance/optimizer/symbols/Symbol.java">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn22': '/QuantDesk_YahooData/java/com/winance/optimizer/symbols/Symbol.java'}
