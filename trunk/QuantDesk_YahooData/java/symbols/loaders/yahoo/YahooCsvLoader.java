...
<body class="t4">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fquantdesk%2Fsource%2Fbrowse%2FQuantDesk_YahooData%2Fjava%2Fcom%2Fwinance%2Foptimizer%2Fsymbols%2Floaders%2Fyahoo%2FYahooCsvLoader.java%3Fspec%3Dsvn22%26r%3D22" 
...
<div id="nav_and_rev" class="heading">
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/?r=22">QuantDesk_YahooData</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/?r=22">java</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/com/?r=22">com</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/com/winance/?r=22">winance</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/com/winance/optimizer/?r=22">optimizer</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/com/winance/optimizer/symbols/?r=22">symbols</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/com/winance/optimizer/symbols/loaders/?r=22">loaders</a><span class="sp">/&nbsp;</span><a href="/p/quantdesk/source/browse/QuantDesk_YahooData/java/com/winance/optimizer/symbols/loaders/yahoo/?r=22">yahoo</a><span class="sp">/&nbsp;</span>YahooCsvLoader.java</span>
...
><td class="source">import com.winance.optimizer.symbols.Symbol;<br></td></tr
><tr
id=sl_svn22_23
...
><td class="source">import java.io.FileReader;<br></td></tr
><tr
id=sl_svn22_26
...
><td class="source">import java.text.ParseException;<br></td></tr
><tr
id=sl_svn22_28
...
><td class="source">public class YahooCsvLoader<br></td></tr
><tr
id=sl_svn22_33
...
><td class="source">    public static Symbol loadFromFile(String fileName, String symbolName)<br></td></tr
><tr
id=sl_svn22_35
...
><td class="source">        Symbol ret = null;<br></td></tr
><tr
id=sl_svn22_37
...
><td class="source">            BufferedReader br = new BufferedReader(new FileReader(fileName));<br></td></tr
><tr
id=sl_svn22_40
...
><td class="source">            ret = new Symbol(symbolName);<br></td></tr
><tr
id=sl_svn22_42
...
><td class="source">            //  skipping headers<br></td></tr
><tr
id=sl_svn22_45

><td class="source">            line = br.readLine();<br></td></tr
><tr
id=sl_svn22_46
...
><td class="source">            while((line = br.readLine()) != null)<br></td></tr
><tr
id=sl_svn22_48
...
><td class="source">                parseAddLine(ret, line);<br></td></tr
><tr
id=sl_svn22_50
...
><td class="source">            System.out.println(&quot;loaded &quot; + ret.getDataItemsCount() + &quot; lines for symbol &#39;&quot; + symbolName + &quot;&#39;&quot;);<br></td></tr
><tr
id=sl_svn22_53
...
><td class="source">            System.out.println(&quot;file &#39;&quot; + fileName + &quot;&#39; not found for symbol &#39;&quot; + symbolName + &quot;&#39;&quot;);<br></td></tr
><tr
id=sl_svn22_57
...
><td class="source">    private static void parseAddLine(Symbol symbol, String line)<br></td></tr
><tr
id=sl_svn22_66
...
><td class="source">        String parts[] = line.split(&quot;,&quot;);<br></td></tr
><tr
id=sl_svn22_68

><td class="source">        //  invalid line format<br></td></tr
><tr
id=sl_svn22_69
...
><td class="source">        if(6 != parts.length)<br></td></tr
><tr
id=sl_svn22_71
...
><td class="source">            SimpleDateFormat df = new SimpleDateFormat();<br></td></tr
><tr
id=sl_svn22_77

><td class="source">            //df.applyPattern(&quot;yyyyMMdd&quot;);<br></td></tr
><tr
id=sl_svn22_78

><td class="source">            df.applyPattern(&quot;yyyy-MM-dd&quot;);<br></td></tr
><tr
id=sl_svn22_79

><td class="source">            Date d = df.parse(parts[0]);<br></td></tr
><tr
id=sl_svn22_80
...
><td class="source">            //System.out.println(d);<br></td></tr
><tr
id=sl_svn22_82
...
><td class="source">            double open = Double.parseDouble(parts[1]);<br></td></tr
><tr
id=sl_svn22_84

><td class="source">            double high = Double.parseDouble(parts[2]);<br></td></tr
><tr
id=sl_svn22_85

><td class="source">            double low = Double.parseDouble(parts[3]);<br></td></tr
><tr
id=sl_svn22_86

><td class="source">            double close = Double.parseDouble(parts[4]);<br></td></tr
><tr
id=sl_svn22_87

><td class="source">            double volume = Double.parseDouble(parts[5]);<br></td></tr
><tr
id=sl_svn22_88
...
><td class="source">            symbol.addDataItem(d, open, high, low, close, volume);<br></td></tr
><tr
id=sl_svn22_90
...
><td class="source">        catch(ParseException e)<br></td></tr
><tr
id=sl_svn22_92
...
<script type="text/javascript">
 ...
 by atramos
 on May 23, 2010
 &nbsp; <a href="/p/quantdesk/source/diff?spec=svn22&r=22&amp;format=side&amp;path=/QuantDesk_YahooData/java/com/winance/optimizer/symbols/loaders/yahoo/YahooCsvLoader.java&amp;old_path=/QuantDesk_YahooData/java/com/winance/optimizer/symbols/loaders/yahoo/YahooCsvLoader.java&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/QuantDesk_YahooData/java/com/winance/optimizer/symbols/loaders/yahoo/YahooCsvLoader.java';
 ...
 <a href="/p/quantdesk/source/list?path=/QuantDesk_YahooData/java/com/winance/optimizer/symbols/loaders/yahoo/YahooCsvLoader.java&start=22">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="http://quantdesk.googlecode.com/svn-history/r22/QuantDesk_YahooData/java/com/winance/optimizer/symbols/loaders/yahoo/YahooCsvLoader.java">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn22': '/QuantDesk_YahooData/java/com/winance/optimizer/symbols/loaders/yahoo/YahooCsvLoader.java'}
