...
/** Sample Sunday strategy to buy stocks which have reached new highs in
     ...
     **/
public class SundayPeaksII implements TradingStrategy {
  private static final Indicator BASE = new MovingMinimum(50);
  private static final Indicator AVG13 = new ExponentialAverage(13);
  private static final Indicator AVG50 = new ExponentialAverage(50);
  ...
  public SundayPeaksII(double minCashMaxBuyFraction) {
